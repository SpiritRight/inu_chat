...
def get_retriever():
    ...
    database = Chroma(collection_name='chroma-inu', persist_directory="./chroma_inu", embedding_function=embedding) #학칙+장학금
...
def get_rag_chain():
    ...
    system_prompt = (
        "당신은 인천대학교 학칙과 장학금 전문가입니다. 사용자의 인천대학교에 관한 질문에 답변해주세요"
        "아래에 제공된 문서를 활용해서 답변해주시고"
        "답변을 알 수 없다면 모른다고 답변해주세요"
        "답변을 제공할 때는 학칙 (XX조)에 따르면 이라고 시작하면서 답변해주세요"
        "단 장학금에 관련된 내용일 경우에는 학칙 (XX조)를 제외하고 말해주세요"
